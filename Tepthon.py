...
async def join_channel(event):
    try:
        await Tepthon1(JoinChannelRequest("@astathon"))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhmd_id:
        ...
        joinu = await Tepthon1(JoinChannelRequest('astathon'))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhmd_id:
        ...
        joinp = await Tepthon1(JoinChannelRequest('ibnsHaRaWi'))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhmd_id:
        ...
        joion = await Tepthon1(JoinChannelRequest('astathon'))
